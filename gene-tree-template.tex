...
\ifthirdpair{
    ...
    \ifshowallelelabels{
        \node [right=0mm of a2, text=\alleleLabelColor] {\tiny ($\allelecount[B], \redallelecount[B]) = (3, 1)$};
        \node [right=0mm of a5, text=\alleleLabelColor] {\tiny ($\allelecount[B], \redallelecount[B]) = (3, 2)$};
    ...
    \ifshowgenetree{
        ...
        \ifshowinternalallelelabels{
            % \node [below=0mm of c3inttop, text=\alleleLabelColor] {\tiny ($\allelecount[T], \redallelecount[T]) = (1, 0)$};
            \node [above right = -1.3mm and -1mm of c3inttop, text=\internalAlleleLabelColor] {\tiny $(\allelecount[T], \redallelecount[T]) = (1, 0)$};
            \node [below right = 0.3mm and -1mm of c3intbottom, text=\internalAlleleLabelColor] {\tiny $(\allelecount[T], \redallelecount[T]) = (1, 0)$};
            \node [left = -1mm of c3intmerge, text=\internalAlleleLabelColor, align=center, font=\tiny\linespread{0.6}] {$(\allelecount[B], \redallelecount[B])$ \\ $= (2, 0)$};
