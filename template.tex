...
%% horizontal lines
\ifshowpopsizelabelsone{
    \draw[line width=\firstPopLineageRootWidth, \popLineageColor] (c1root) -- (c1int) node[midway, text=\popSizeLabelColor] {\rootSizeLabelCompOne};
}{
    \draw[line width=\firstPopLineageRootWidth, \popLineageColor] (c1root) -- (c1int);
}
\iffirstpair{
    \ifshowpopsizelabelsone{
        \draw[line width=\firstPopLineageLeafWidth, \popLineageColor] (c1inttop) -- (c1tiptop) node[midway, text=\popSizeLabelColor] {\tipTopSizeLabelCompOne};
        \draw[line width=\firstPopLineageLeafWidth, \popLineageColor] (c1intbottom) -- (c1tipbottom) node[midway, text=\popSizeLabelColor] {\tipBottomSizeLabelCompOne};
    }{
    ...
    \ifshowpopsizelabelsone{
        \draw[line width=\firstPopLineageLeafWidth, \popLineageColor] (c1int) -- (c1tip) node[midway, text=\popSizeLabelColor] {\tipSizeLabelCompOne};
    }{
        \draw[line width=\firstPopLineageLeafWidth, \popLineageColor] (c1int) -- (c1tip);
    }
}

\ifshowpopsizelabelstwo{
    \draw[line width=\secondPopLineageRootWidth, \popLineageColor] (c2root) -- (c2int) node[midway, text=\popSizeLabelColor] {\rootSizeLabelCompTwo};
}{
    \draw[line width=\secondPopLineageRootWidth, \popLineageColor] (c2root) -- (c2int);
}
\ifsecondpair{
    \ifshowpopsizelabelstwo{
        \draw[line width=\secondPopLineageLeafWidth, \popLineageColor] (c2inttop) -- (c2tiptop) node[midway, text=\popSizeLabelColor] {\tipTopSizeLabelCompTwo};
        \draw[line width=\secondPopLineageLeafWidth, \popLineageColor] (c2intbottom) -- (c2tipbottom) node[midway, text=\popSizeLabelColor] {\tipBottomSizeLabelCompTwo};
    }{
    ...
    \ifshowpopsizelabelstwo{
        \draw[line width=\secondPopLineageLeafWidth, \popLineageColor] (c2int) -- (c2tip) node[midway, text=\popSizeLabelColor] {\tipSizeLabelCompTwo};
    }{
...
\ifshowpopsizelabels{
    \draw[line width=\thirdPopLineageRootWidth, \popLineageColor] (c3root) -- (c3int) node[midway, text=\popSizeLabelColor] {\rootSizeLabelCompThree};
}{
    \draw[line width=\thirdPopLineageRootWidth, \popLineageColor] (c3root) -- (c3int);
}
\ifthirdpair{
    \ifshowpopsizelabels{
        \draw[line width=\thirdPopLineageLeafWidth, \popLineageColor] (c3inttop) -- (c3tiptop) node[midway, text=\popSizeLabelColor] {\tipTopSizeLabelCompThree};
    \draw[line width=\thirdPopLineageLeafWidth, \popLineageColor] (c3intbottom) -- (c3tipbottom) node[midway, text=\popSizeLabelColor] {\tipBottomSizeLabelCompThree};
    }{
    ...
    \ifshowpopsizelabels{
        \draw[line width=\thirdPopLineageLeafWidth, \popLineageColor] (c3int) -- (c3tip) node[midway, text=\popSizeLabelColor] {\tipSizeLabelCompThree};
    }{
